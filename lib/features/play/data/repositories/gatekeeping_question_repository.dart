...
class GatekeepingQuestionRepository {
  ...
  static final List<GatekeepingQuestion> _allQuestions = [
    ...
    GatekeepingQuestion(
      id: 'logic_31',
      imagePath: _diagramPath(Difficulty.logic, 'logic_31.png'),
      expression: '(A __AND B) __NAND C',
      answers: ['AND', 'NAND'],
      difficulty: Difficulty.logic,
    ),
    GatekeepingQuestion(
      id: 'logic_32',
      imagePath: _diagramPath(Difficulty.logic, 'logic_32.png'),
      expression: '(A __OR B) __NOR C',
      answers: ['OR', 'NOR'],
      difficulty: Difficulty.logic,
    ),
    GatekeepingQuestion(
      id: 'logic_33',
      imagePath: _diagramPath(Difficulty.logic, 'logic_33.png'),
    ...
    GatekeepingQuestion(
      id: 'logic_34',
      imagePath: _diagramPath(Difficulty.logic, 'logic_34.png'),
      expression: '__NOT(A __OR B) __XNOR C',
      answers: ['NOT', 'OR', 'XNOR'],
      difficulty: Difficulty.logic,
    ),
    GatekeepingQuestion(
      id: 'logic_35',
      imagePath: _diagramPath(Difficulty.logic, 'logic_35.png'),
      expression: 'A __NAND (B __AND C)',
      answers: ['NAND', 'AND'],
      difficulty: Difficulty.logic,
    ),
    GatekeepingQuestion(
      id: 'logic_36',
      imagePath: _diagramPath(Difficulty.logic, 'logic_36.png'),
      expression: 'A __NOR (B __OR C)',
      answers: ['NOR', 'OR'],
      difficulty: Difficulty.logic,
    ),
    GatekeepingQuestion(
      id: 'logic_37',
      imagePath: _diagramPath(Difficulty.logic, 'logic_37.png'),
      expression: '__NOT A __NAND __NOT B',
      answers: ['NOT', 'NAND', 'NOT'],
      difficulty: Difficulty.logic,
    ),
    GatekeepingQuestion(
      id: 'logic_38',
      imagePath: _diagramPath(Difficulty.logic, 'logic_38.png'),
      expression: '__NOT A __NOR __NOT B',
      answers: ['NOT', 'NOR', 'NOT'],
      difficulty: Difficulty.logic,
    ),
    GatekeepingQuestion(
    ...
    GatekeepingQuestion(
      id: 'logic_40',
      imagePath: _diagramPath(Difficulty.logic, 'logic_40.png'),
      expression: '(A __XNOR B) __OR (B __XNOR C)',
      answers: ['XNOR', 'OR', 'XNOR'],
      difficulty: Difficulty.logic,
    ),
    GatekeepingQuestion(
      id: 'logic_41',
      imagePath: _diagramPath(Difficulty.logic, 'logic_41.png'),
      expression: 'A __AND __NOT(B __NAND C)',
      answers: ['AND', 'NOT', 'NAND'],
      difficulty: Difficulty.logic,
    ),
    GatekeepingQuestion(
      id: 'logic_42',
      imagePath: _diagramPath(Difficulty.logic, 'logic_42.png'),
      expression: 'A __OR __NOT(B __NOR C)',
      answers: ['OR', 'NOT', 'NOR'],
      difficulty: Difficulty.logic,
    ),
    GatekeepingQuestion(
      id: 'logic_43',
      imagePath: _diagramPath(Difficulty.logic, 'logic_43.png'),
      expression: '__NOT(A __XOR B) __NAND C',
      answers: ['NOT', 'XOR', 'NAND'],
      difficulty: Difficulty.logic,
    ),
    GatekeepingQuestion(
      id: 'logic_44',
    ...
    GatekeepingQuestion(
      id: 'logic_45',
      imagePath: _diagramPath(Difficulty.logic, 'logic_45.png'),
      expression: '(A __NAND B) __XOR (B __NOR C)',
      answers: ['NAND', 'XOR', 'NOR'],
      difficulty: Difficulty.logic,
    ),
