...
class GatekeepingQuestionRepository {
  ...
  static final List<GatekeepingQuestion> _allQuestions = [
    ...
    GatekeepingQuestion(
      ...
      expression: '__NOT A __AND B __NOT',
      answers: ['NOT', 'AND', 'NOT'],
      difficulty: GatekeepingDifficulty.basic,
    ),
    GatekeepingQuestion(
    ...
    GatekeepingQuestion(
      ...
      expression: '(NOT(A) __AND NOT(B)) __AND (NOT(A) __OR NOT(C))',
      answers: ['AND', 'AND', 'OR'],
      difficulty: GatekeepingDifficulty.manic,
    ),
    GatekeepingQuestion(
    ...
    GatekeepingQuestion(
      ...
      expression: '(NOT(A) __OR NOT(B)) __XOR C',
      answers: ['OR', 'XOR'],
      difficulty: GatekeepingDifficulty.manic,
    ),
    GatekeepingQuestion(
      ...
      expression: '(NOT(A) __OR NOT(B)) __AND (NOT(B) __OR NOT(C)) __AND A',
    ...
    GatekeepingQuestion(
      ...
      expression: '(NOT(A) __AND NOT(B)) __AND (NOT(C) __OR NOT(D))',
      answers: ['AND', 'AND', 'OR'],
      difficulty: GatekeepingDifficulty.manic,
    ),
    GatekeepingQuestion(
      ...
      expression: '(NOT(A) __AND NOT(B)) __OR C',
      answers: ['AND', 'OR'],
      difficulty: GatekeepingDifficulty.manic,
    ),
    GatekeepingQuestion(
    ...
    GatekeepingQuestion(
      ...
      expression: '(NOT(A) __AND NOT(B)) __XOR (A __XNOR C)',
    ...
    GatekeepingQuestion(
      ...
      expression: 'C __XOR (NOT(A) __AND NOT(B))',
      answers: ['XOR', 'AND'],
      difficulty: GatekeepingDifficulty.manic,
    ),
    GatekeepingQuestion(
    ...
    GatekeepingQuestion(
      ...
      expression: '(NOT(A) __OR NOT(B)) __AND NOT(C)',
      answers: ['OR', 'AND'],
      difficulty: GatekeepingDifficulty.manic,
    ),
    GatekeepingQuestion(
      ...
      expression: '(NOT(A) __OR NOT(B)) __XOR (NOT(B) __AND NOT(C) __AND A)',
