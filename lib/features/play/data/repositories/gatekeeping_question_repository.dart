...
class GatekeepingQuestionRepository {
  ...
  static final List<GatekeepingQuestion> _allQuestions = [
    ...
    GatekeepingQuestion(
      id: 'basic_31',
      imagePath: _diagramPath(Difficulty.basic, 'basic_31.png'),
    ...
    GatekeepingQuestion(
      id: 'basic_32',
      imagePath: _diagramPath(Difficulty.basic, 'basic_32.png'),
    ...
    GatekeepingQuestion(
      id: 'basic_33',
      imagePath: _diagramPath(Difficulty.basic, 'basic_33.png'),
      expression: 'A __AND __NOT (B __OR C)',
      answers: ['AND', 'NOT', 'OR'],
      difficulty: Difficulty.basic,
    ),
    GatekeepingQuestion(
      id: 'basic_34',
      imagePath: _diagramPath(Difficulty.basic, 'basic_34.png'),
      expression: 'A __OR __NOT (B __AND C)',
      answers: ['OR', 'NOT', 'AND'],
      difficulty: Difficulty.basic,
    ),
    GatekeepingQuestion(
      id: 'basic_35',
      imagePath: _diagramPath(Difficulty.basic, 'basic_35.png'),
    ...
    GatekeepingQuestion(
      id: 'basic_36',
      imagePath: _diagramPath(Difficulty.basic, 'basic_36.png'),
    ...
    GatekeepingQuestion(
      id: 'basic_37',
      imagePath: _diagramPath(Difficulty.basic, 'basic_37.png'),
      expression: 'C __OR (A __AND __NOT B)',
      answers: ['OR', 'AND', 'NOT'],
      difficulty: Difficulty.basic,
    ),
    GatekeepingQuestion(
      id: 'basic_38',
      imagePath: _diagramPath(Difficulty.basic, 'basic_38.png'),
      expression: '(C __OR B) __AND __NOT A',
      answers: ['OR', 'AND', 'NOT'],
      difficulty: Difficulty.basic,
    ),
    GatekeepingQuestion(
      id: 'basic_39',
      imagePath: _diagramPath(Difficulty.basic, 'basic_39.png'),
      expression: '__NOT B __AND __NOT C',
      answers: ['NOT', 'AND', 'NOT'],
      difficulty: Difficulty.basic,
    ),
    GatekeepingQuestion(
      id: 'basic_40',
      imagePath: _diagramPath(Difficulty.basic, 'basic_40.png'),
    ...
    GatekeepingQuestion(
      id: 'basic_41',
      imagePath: _diagramPath(Difficulty.basic, 'basic_41.png'),
      expression: '__NOT (__NOT A)',
      answers: ['NOT', 'NOT'],
      difficulty: Difficulty.basic,
    ),
    ...
    GatekeepingQuestion(
      id: 'basic_42',
      imagePath: _diagramPath(Difficulty.basic, 'basic_42.png'),
      expression: '(A __AND C) __AND __NOT B',
      answers: ['AND', 'AND', 'NOT'],
      difficulty: Difficulty.basic,
    ),
    GatekeepingQuestion(
      id: 'basic_43',
      imagePath: _diagramPath(Difficulty.basic, 'basic_43.png'),
      expression: '(A __OR C) __OR __NOT B',
      answers: ['OR', 'OR', 'NOT'],
      difficulty: Difficulty.basic,
    ),
    GatekeepingQuestion(
      id: 'basic_44',
      imagePath: _diagramPath(Difficulty.basic, 'basic_44.png'),
      expression: '__NOT C __OR (A __AND B)',
      answers: ['NOT', 'OR', 'AND'],
      difficulty: Difficulty.basic,
    ),
    GatekeepingQuestion(
      id: 'basic_45',
      imagePath: _diagramPath(Difficulty.basic, 'basic_45.png'),
      expression: '__NOT C __AND (A __OR B)',
      answers: ['NOT', 'AND', 'OR'],
      difficulty: Difficulty.basic,
    ),
    GatekeepingQuestion(
      id: 'basic_46',
      imagePath: _diagramPath(Difficulty.basic, 'basic_46.png'),
      expression: 'B __OR (__NOT A __AND C)',
      answers: ['OR', 'NOT', 'AND'],
      difficulty: Difficulty.basic,
    ),
    GatekeepingQuestion(
      id: 'basic_47',
      imagePath: _diagramPath(Difficulty.basic, 'basic_47.png'),
      expression: 'B __AND (__NOT A __OR C)',
      answers: ['AND', 'NOT', 'OR'],
      difficulty: Difficulty.basic,
    ),
    GatekeepingQuestion(
      id: 'basic_48',
      imagePath: _diagramPath(Difficulty.basic, 'basic_48.png'),
      expression: 'C __OR __NOT (A __AND B)',
      answers: ['OR', 'NOT', 'AND'],
      difficulty: Difficulty.basic,
    ),
    GatekeepingQuestion(
      id: 'basic_49',
      imagePath: _diagramPath(Difficulty.basic, 'basic_49.png'),
      expression: 'C __AND __NOT (A __OR B)',
      answers: ['AND', 'NOT', 'OR'],
      difficulty: Difficulty.basic,
    ),
    GatekeepingQuestion(
      id: 'basic_50',
      imagePath: _diagramPath(Difficulty.basic, 'basic_50.png'),
      expression: '(A __AND __NOT C) __OR B',
      answers: ['AND', 'NOT', 'OR'],
      difficulty: Difficulty.basic,
    ),
